    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          <h3 className={`text-sm font-semibold leading-snug ${deal.expired ? "text-zinc-500" : "text-zinc-100 group-hover:text-white"}`}>
            {deal.title}
          </h3>
        ...
        <div className="shrink-0 text-right">
          <div className={`inline-block text-xs font-bold px-2 py-1 rounded-lg ${deal.expired ? "bg-zinc-800 border border-zinc-700 text-zinc-500" : "bg-emerald-500/10 border border-emerald-500/20 text-emerald-400"}`}>
            -{deal.discount}%
          </div>
        </div>
      </div>
      <div className="flex items-end justify-between">
        <div className="flex items-baseline gap-2">
          <span className={`text-xl font-bold font-mono ${deal.expired ? "text-zinc-500" : "text-white"}`}>
